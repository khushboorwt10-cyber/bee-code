...
const _primary = TermsConditionViewModel.primary;
const _secondary = TermsConditionViewModel.secondary;

class TermsConditionScreen extends GetView<TermsConditionViewModel> {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _SectionLabel(label: 'Terms Sections'),
                          SizedBox(height: 14.h),
...
class _TopBar extends StatelessWidget {
  final TermsConditionViewModel vm;
        ...
        children: [
          Row(
            children: [
              ...
              _IconBtn(
                  icon: Icons.ios_share_rounded, onTap: vm.shareTerms),
            ],
          ),
...
class _QuickStats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final stats = [
      ...
      {'icon': Icons.timer_outlined, 'value': '4 min', 'label': 'Read time'},
      {'icon': Icons.balance_outlined, 'value': 'Legal', 'label': 'Binding'},
    ];
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Icon(section.icon,
                        color:
                            isExpanded ? _primary : Colors.black45,
                        size: 17.sp),
                  ),
                  SizedBox(width: 12.w),
                  Expanded(
                  ...
                  AnimatedRotation(
                    ...
                    child: Icon(Icons.keyboard_arrow_down_rounded,
                        color:
                            isExpanded ? _primary : Colors.black38,
                        size: 22.sp),
                  ),
                ],
              ),
    ...
    return Container(
      ...
      child: Obx(() => Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: vm.hasReadTerms.value ? vm.acceptTerms : null,
                child: AnimatedContainer(
                  duration: const Duration(milliseconds: 300),
                  width: double.infinity,
                  padding: EdgeInsets.symmetric(vertical: 14.h),
                  decoration: BoxDecoration(
                    gradient: vm.hasReadTerms.value
                        ? const LinearGradient(
                            colors: [_primary, _secondary],
                          )
                        : null,
                    color: vm.hasReadTerms.value
                        ? null
                        : Colors.grey.shade200,
                    borderRadius: BorderRadius.circular(14.r),
                    boxShadow: vm.hasReadTerms.value
                        ? [
                            BoxShadow(
